...
if (!empty($erros)) {
    echo "
        <html>
            <head>
                <META http-equiv=\"refresh\" content=\"0;URL=http://localhost:8088/pages/cad-cidade.php\">
            </head>
    ...
    <html>
        <head>
            <META http-equiv=\"refresh\" content=\"1;URL=http://localhost:8088/pages/lista-cidade.php\">
        </head>
    </html>";
}
?>