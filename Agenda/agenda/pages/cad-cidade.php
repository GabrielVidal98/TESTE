    ...
    <div class="register-box">
        ...
        <form action="grava-cidade.php" method="post" autocomplete="off">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="nome_cidade" required placeholder="Nome da Cidade" aria-describedby="input-nome_cidade">
            </div>
            <br>
            ...
            <div class="row" style="margin-bottom:10px">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block btn-flat">
                        <span class="fas fa-chevron-circle-right"> Inserir!</span>
                    </button>
                </div>
            </div>
        </form>
